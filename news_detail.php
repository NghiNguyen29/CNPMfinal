...
$id = $_GET['id'];
$news_detail = read_news_by_id($id);
?>
...
<body>
    ...
    <div class="container news">
        ...
        <div class="row">
            <div class="col-9 p-0 pb-4 ">
                <h1 style="font-size:18px" class="font-weight-bold mb-4"><?= $news_detail[0]['NAME'] ?></h1>
                <div class="text-justify mr-3 my-4 px-4 py-3 border bg-light" style="line-height: 26px;"><?= $news_detail[0]['SUMMARY'] ?></div>
                <div class="text-justify mr-3 news-content" style="line-height: 26px;"><?= $news_detail[0]['CONTENT'] ?></div>
            </div>
            <div class="col-3">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('img').parent().addClass('img-center');
        })
